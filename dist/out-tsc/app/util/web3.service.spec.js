...
describe('Web3Service', () => {
    ...
    it('should be created', inject([Web3Service], (service) => {
        expect(service).toBeTruthy();
    }));
    it('should inject a default web3 on a contract', inject([Web3Service], (service) => {
    ...
    it('should inject a the window web3 on a contract', inject([Web3Service], (service) => {
        window.ethereum = new Web3.providers.HttpProvider('http://localhost:1337');
        window.ethereum.enable = () => __awaiter(void 0, void 0, void 0, function* () { return true; });
        service.bootstrapWeb3();
        return service.artifactsToContract(metacoin_artifacts).then((abstraction) => {
