        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
            <StyledInfo>
              ...
              of xSushi held relative the weight of the staking. xSushi can be
              minted by staking Sushi. To redeem Sushi staked plus swap fees
              convert xSushi back to Sushi.{' '}
              {totalSupply
                ? `There are currently ${getBalanceNumber(
                    totalSupply,
                  )} xSUSHI in the whole pool.`
                : ''}
            </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
