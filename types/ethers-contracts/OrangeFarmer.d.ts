...
interface OrangeFarmerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "juicyPerBlock()": FunctionFragment;
    ...
    "pendingJuicy(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "juicyPerBlock",
    values?: undefined
  ): string;
...
export class OrangeFarmer extends Contract {
  ...
  juicyPerBlock(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    juicyPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
